    ...
    <div class="mt-4">
        <div class="flex flex-wrap -mx-6">
            <x-card>
                ...
                <x-slot:count> {{ count($employees) }}</x-slot:count>
                Total Employees
            </x-card>
            ...
            <x-card>
                ...
                <x-slot:count> {{ count($clinic_records) }} </x-slot:count>
            ...
            <x-card>
                ...
                <x-slot:count> 1234 </x-slot:count>
                Total Training Record
            </x-card>
    ...
    <x-table.wide-table>
        <thead>
            <tr>
                ...
                <x-table.th >Project Location</x-table.th>              
